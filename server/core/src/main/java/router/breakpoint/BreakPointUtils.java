...
public class BreakPointUtils {
    ...
    public static void createMethodBreakPointFront(VirtualMachine virtualMachine, String className, String methodName, BreakPointHandler handler) {
        internalCreateMethodBreakPoint(virtualMachine, new MethodPoint(className, methodName, handler), 0);
    }
}
